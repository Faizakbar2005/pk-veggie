...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("https://374d-202-51-197-10.ngrok-free.app/register", {
        method: "POST",
        headers: {
                  ...
                  <div className="relative w-full mb-3">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="border-0 px-3 py-3 pr-12 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      ...
                      <button
                        ...
                        className="absolute inset-y-0 right-0 pr-3 pl-2 flex items-center text-blueGray-400 hover:text-blueGray-600 focus:outline-none transition-colors duration-150"
                      >
                        {showPassword ? (
